...
## Corpus Check
- 116 files · ~113,201 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 832 nodes · 1390 edges · 48 communities (43 shown, 5 thin omitted)
...
Cohesion: 0.07
Nodes (44): Lightbox(), Callout(), CALLOUT_MAP, CodeBlock(), extractText(), HeadingLink(), MarkdownViewer(), remarkInteractiveBlockMeta() (+36 more)
...
Cohesion: 0.05
Nodes (54): clampWidth(), DocsApp(), loadSidebarWidth(), Theme, WorkspaceLite, Props, READER_THEME_META, READING_FONT_META (+46 more)
...
- **Why does `cn()` connect `DocumentViewer.tsx` to `carousel.tsx`, `MarkdownViewer.tsx`, `sidebar.tsx`, `utils.ts`, `sheet.tsx`, `persistence.ts`, `command.tsx`, `menubar.tsx`, `InteractiveBlock.tsx`, `persistence.ts`, `workspace-artifacts.ts`, `sheet.tsx`, `context-menu.tsx`, `alert-dialog.tsx`, `table.tsx`, `breadcrumb.tsx`, `drawer.tsx`, `navigation-menu.tsx`, `card.tsx`, `toggle-group.tsx`, `input-otp.tsx`, `avatar.tsx`, `WorkspaceSheet.tsx`?**
