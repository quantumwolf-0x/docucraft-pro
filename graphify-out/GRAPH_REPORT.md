...
## Corpus Check
- 116 files · ~113,870 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 836 nodes · 1398 edges · 58 communities (54 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `923d7dea`
...
Cohesion: 0.07
Nodes (47): Lightbox(), Callout(), CALLOUT_MAP, CodeBlock(), extractText(), HeadingLink(), MarkdownViewer(), remarkInteractiveBlockMeta() (+39 more)
...
Cohesion: 0.16
Nodes (17): clampWidth(), DocsApp(), loadSidebarWidth(), Theme, WorkspaceLite, readingMinutes(), loadPrefs(), parseWorkspaceImport() (+9 more)
...
Cohesion: 0.10
Nodes (18): jszip, xlsx, decodeXml(), DocxViewer(), extractLegacyPptSlides(), GoogleProps, MammothBrowser, PresentationViewer() (+10 more)

### Community 26 - "sheet.tsx"
Cohesion: 0.11
Nodes (15): Props, READER_THEME_META, READING_FONT_META, READING_MODE_META, SettingsPage(), SettingsPageProps, StorageSettings(), Props (+7 more)
...
Cohesion: 0.20
Nodes (17): DocumentViewer(), PdfViewer(), EmbeddedMarkdown(), InlineArtifact(), renderArtifact(), useObjectUrl(), dataUrlToBlob(), getDocumentKind() (+9 more)
...
Cohesion: 0.21
Nodes (12): GoogleViewer(), dataUrl(), fileExtension(), googleUrl(), importDocumentFile(), isTextKind(), kindByExtension, MdChunk (+4 more)
...
### Community 45 - "chart.tsx"
Cohesion: 0.20
Nodes (7): ChartConfig, ChartContainer, ChartContext, ChartContextProps, ChartLegendContent, ChartTooltipContent, THEMES

### Community 48 - "MdFile"
Cohesion: 0.33
Nodes (6): CommandPalette(), Hit, Props, Props, MdFile, ResolvedArtifact
...
### Community 50 - "react"
Cohesion: 0.40
Nodes (5): react, useCarousel(), useChart(), useFormField(), useSidebar()
...
- **Why does `cn()` connect `DocumentViewer.tsx` to `carousel.tsx`, `MarkdownViewer.tsx`, `sidebar.tsx`, `utils.ts`, `sheet.tsx`, `persistence.ts`, `command.tsx`, `menubar.tsx`, `InteractiveBlock.tsx`, `persistence.ts`, `workspace-artifacts.ts`, `context-menu.tsx`, `alert-dialog.tsx`, `table.tsx`, `breadcrumb.tsx`, `drawer.tsx`, `navigation-menu.tsx`, `card.tsx`, `toggle-group.tsx`, `input-otp.tsx`, `avatar.tsx`, `carousel.tsx`, `chart.tsx`, `WorkspaceSheet.tsx`, `alert.tsx`?**
  _High betweenness centrality (0.272) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `routeTree.gen.ts`, `input-otp.tsx`, `package.json`, `Sidebar.tsx`, `react`, `markdown-utils.ts`?**
  _High betweenness centrality (0.201) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `dependencies`, `sidebar.tsx`, `DocumentViewer.tsx`?**
